...
class SortAndFilterToYou extends StatefulWidget {
  final List<Activity> activities;
  SortAndFilterToYou({this.activities});
  @override
  _SortAndFilterToYouState createState() => _SortAndFilterToYouState();
}

class _SortAndFilterToYouState extends State<SortAndFilterToYou> {
                  ...
                  if (!_tasksFilter.filter.contains("All")) {
                    ...
                    if (_eventFilter.checked)
                      _activities.addAll(widget.activities
                          .eventAndStatus(status: _eventFilter.status));
                    print('activities === ${_activities.length}');
                    if (_assignmentFilter.checked)
                      _activities.addAll(widget.activities.assignmentAndStatus(
                          status: _assignmentFilter.status));
                    print('activities === ${_activities.length}');
                  } else {
                    _activities.addAll(widget.activities);
                  }
